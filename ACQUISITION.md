...
Polyglot migration and universal execution runtime Capture program state in one language, encode it as language-neutral IR, restore or migrate it in another.
