# Transfer manifest â€” Value migration (Python Ã¢â€ â€ JavaScript)

## Schedule A â€” Included (typical)

1. Git repository `theworker02/Parallax` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Value migration (Python Ã¢â€ â€ JavaScript)
