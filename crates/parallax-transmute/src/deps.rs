...
impl DependencyMapDb {
    ...
    pub fn builtin() -> Self {
        ...
        db.insert(DepMapping {
            ...
            name: "express".into(),
            equivalents: vec![
                eq("crates.io", "axum", 0.9, 0.85, 0.8, "async", "mature", "HTTP server framework"),
                eq("crates.io", "actix-web", 0.85, 0.8, 0.85, "async", "mature", "Alternative web framework"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "npm".into(),
        ...
        db.insert(DepMapping {
            ...
            name: "fastapi".into(),
            equivalents: vec![
                eq("crates.io", "axum", 0.85, 0.75, 0.8, "async", "mature", "HTTP API framework"),
                eq("go", "chi", 0.7, 0.55, 0.65, "goroutines", "mature", "Go HTTP router"),
                eq("npm", "fastify", 0.75, 0.7, 0.7, "async", "mature", "Node HTTP framework"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "pypi".into(),
        ...
        db.insert(DepMapping {
            ...
            equivalents: vec![
                eq("crates.io", "sqlx", 0.8, 0.6, 0.7, "async", "mature", "Query-first SQL"),
                eq("crates.io", "diesel", 0.75, 0.65, 0.75, "sync", "mature", "ORM-style"),
                eq("crates.io", "sea-orm", 0.78, 0.7, 0.75, "async", "growing", "Async ORM"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "pypi".into(),
        ...
        db.insert(DepMapping {
            ...
            name: "prisma".into(),
            equivalents: vec![
                eq("crates.io", "sqlx", 0.75, 0.5, 0.65, "async", "mature", "Prefer regenerating from schema"),
                eq("crates.io", "sea-orm", 0.72, 0.6, 0.7, "async", "growing", "ORM closer to Prisma models"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "npm".into(),
        ...
        db.insert(DepMapping {
            ...
            equivalents: vec![
                eq("crates.io", "axum", 0.55, 0.35, 0.45, "async", "mature", "Experimental mapping"),
                eq("go", "gin", 0.5, 0.4, 0.45, "goroutines", "mature", "Experimental"),
            ],
        });
        db.insert(DepMapping {
        ...
        db.insert(DepMapping {
            ...
            equivalents: vec![
                eq("crates.io", "sqlx", 0.78, 0.55, 0.65, "async", "mature", "Schema-first SQL"),
                eq("crates.io", "sea-orm", 0.75, 0.6, 0.68, "async", "growing", "ORM-style models"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "pypi".into(),
        ...
        db.insert(DepMapping {
            ...
            equivalents: vec![
                eq("crates.io", "axum", 0.78, 0.65, 0.7, "async", "mature", "HTTP framework"),
                eq("go", "gin-gonic/gin", 0.85, 0.8, 0.82, "goroutines", "mature", "Stay in Go"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "go".into(),
            ...
            equivalents: vec![
                eq("crates.io", "axum", 0.76, 0.62, 0.68, "async", "mature", "HTTP framework"),
                eq("go", "gin-gonic/gin", 0.82, 0.75, 0.78, "goroutines", "mature", "Stay in Go"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "go".into(),
            ...
            equivalents: vec![
                eq("crates.io", "sqlx", 0.7, 0.5, 0.6, "async", "mature", "Query-first SQL"),
                eq("crates.io", "sea-orm", 0.68, 0.55, 0.58, "async", "growing", "ORM-style"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "npm".into(),
        ...
        db.insert(DepMapping {
            ...
            equivalents: vec![
                eq("crates.io", "prost", 0.85, 0.7, 0.75, "n/a", "mature", "Protobuf codegen"),
                eq("crates.io", "tonic", 0.8, 0.65, 0.7, "async", "mature", "gRPC + prost"),
            ],
        });
        db.insert(DepMapping {
            ecosystem: "npm".into(),
